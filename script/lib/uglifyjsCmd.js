const UglifyJS=(function (n, e) {
    ...
    function h(n, e) {
        function t(n, t) {
            for (var r = [], i = 0, o = 0,
                     a = 0; i < n.length && o < t.length;)e(n[i], t[o]) <= 0 ? r[a++] = n[i++] : r[a++] = t[o++];
    ...
    function g(e, t, r, i) {
        ...
        for (var a = "return function AST_" + e + "(props){ if (props) { ",
                 u = t.length; --u >= 0;)a += "this." + t[u] + " = props." + t[u] + ";";
        var s = i && new i;
    ...
    function M(n, e, t, r) {
        ...
        function g() {
            for (var n, e, t = !1, r = "",
                     a = !1; null != (n = i());)if (t) "u" != n && d("Expecting UnicodeEscapeSequence -- uXXXX"), n = m(), B(n) || d("Unicode char: " + n.charCodeAt(0) + " is not valid in identifier"), r += n, t = !1; else if ("\\" == n) a = t = !0, o(); else {
                if (!B(n))break;
                r += o()
            }
        ...
        var k = {
            ...
            for (var e, t = !1,
                     r = !1; e = o(!0);)if (t) n += "\\" + e, t = !1; else if ("[" == e) r = !0, n += e; else if ("]" == e && r) r = !1, n += e; else {
                if ("/" == e && !r)break;
                "\\" == e ? t = !0 : n += e
            }
            var i = g();
    ...
    function z(n, e) {
        ...
        function C() {
            p("{");
            for (var n, e = [], r = null,
                     o = null; !t("punc", "}");)t("eof") && f(), t("keyword", "case") ? (o && (o.end = a()), r = [], o = new kn({
                start: (n = I.token, i(), n),
                expression: Fn(!0),
                body: r
        ...
        function S(n, e, r) {
            for (var o = !0,
                     a = []; !t("punc", n) && (o ? o = !1 : p(","), !e || !t("punc", n));)t("punc", ",") && r ? a.push(new ye({
                start: I.token,
                end: I.token
            })) : a.push(Fn(!1));
            return i(), a
        ...
        n(Y, function (n, e) {
            ...
            if (n.option("unused") && !(t instanceof ln) && !t.uses_eval) {
                ...
                var c = new H(function (o, a, u) {
                    if (o instanceof pn && !(o instanceof dn) && !n.option("keep_fargs"))for (var s = o.argnames,
                                                                                                  f = s.length; --f >= 0;) {
                        var l = s[f];
